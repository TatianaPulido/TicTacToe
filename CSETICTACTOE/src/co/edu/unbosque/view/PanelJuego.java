...
public class PanelJuego extends JPanel {
	...
	public void asignarValorJTextField(String valor, int pos) {
		posicion[pos].setText(valor);
	}

	public void cargarValoresJTextField() {
		for (int i = 0; i < 9; i++) {
			posicion[i].getText();
		}
	...
	public void inhabilitarCampos(int pos) {
		posicion[pos].setEnabled(false);
	}

	public void vaciarCampos(int pos) {
		posicion[pos].setText(null);
	}
}